...
public extension StateSetProtocol {
    ...
    @inlinable func andSets<StateSetT: StateSetProtocol>(compareSet: StateSetT) -> Atk.StateSetRef! {
    ...
    @inlinable func orSets<StateSetT: StateSetProtocol>(compareSet: StateSetT) -> Atk.StateSetRef! {
    ...
    /// one of the two sets.
    @inlinable func xorSets<StateSetT: StateSetProtocol>(compareSet: StateSetT) -> Atk.StateSetRef! {
