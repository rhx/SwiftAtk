...
public extension GObjectAccessibleRef {
    ...
    @inlinable static func for_<GObjectObjectT: GLibObject.ObjectProtocol>(object obj: GObjectObjectT) -> Atk.ObjectRef! {
...
open class GObjectAccessible: Object, GObjectAccessibleProtocol {
    ...
    /// Gets the accessible object for the specified `obj`.
    @inlinable public static func for_<GObjectObjectT: GLibObject.ObjectProtocol>(object obj: GObjectObjectT) -> Atk.Object! {
            let result = atk_gobject_accessible_for_object(obj.object_ptr)
