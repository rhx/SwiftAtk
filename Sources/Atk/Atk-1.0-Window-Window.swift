...
public extension WindowRef {
    ...
    init(_ p: UnsafeMutablePointer<AtkWindow>) {
...
open class Window: Object, WindowProtocol {
    ...
    public init(_ op: UnsafeMutablePointer<AtkWindow>) {
        super.init(cast(op))
    }
    ...
    public convenience init<T>(cPointer: UnsafeMutablePointer<T>) {
        self.init(cPointer.withMemoryRebound(to: AtkWindow.self, capacity: 1) { $0 })
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `WindowProtocol`.**
    public convenience init(raw: UnsafeRawPointer) {
        self.init(UnsafeMutableRawPointer(mutating: raw).assumingMemoryBound(to: AtkWindow.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `WindowProtocol`.**
    public convenience init(raw: UnsafeMutableRawPointer) {
        self.init(raw.assumingMemoryBound(to: AtkWindow.self))
    }

    /// Unsafe untyped initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `WindowProtocol`.**
    public convenience init(opaquePointer: OpaquePointer) {
        self.init(UnsafeMutablePointer<AtkWindow>(opaquePointer))
    }
...
public extension WindowProtocol {
    ...
    var window_ptr: UnsafeMutablePointer<AtkWindow> { return ptr.assumingMemoryBound(to: AtkWindow.self) }
