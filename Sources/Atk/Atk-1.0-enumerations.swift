...
public extension KeyEventType {
    ...
    static let last_defined = ATK_KEY_EVENT_LAST_DEFINED /* 2 */
}
...
public extension RelationType {
    ...
    static let controlled_by = ATK_RELATION_CONTROLLED_BY /* 1 */
    /// Indicates an object is an controller for one or more target objects.
    static let controller_for = ATK_RELATION_CONTROLLER_FOR /* 2 */
    /// Indicates an object is a label for one or more target objects.
    static let label_for = ATK_RELATION_LABEL_FOR /* 3 */
    /// Indicates an object is labelled by one or more target objects.
    static let labelled_by = ATK_RELATION_LABELLED_BY /* 4 */
    /// Indicates an object is a member of a group of one or more target objects.
    static let member_of = ATK_RELATION_MEMBER_OF /* 5 */
    /// Indicates an object is a cell in a treetable which is displayed because a cell in the same column is expanded and identifies that cell.
    static let node_child_of = ATK_RELATION_NODE_CHILD_OF /* 6 */
    /// Indicates that the object has content that flows logically to another
    ///  AtkObject in a sequential way, (for instance text-flow).
    static let flows_to = ATK_RELATION_FLOWS_TO /* 7 */
    /// Indicates that the object has content that flows logically from
    ///  another AtkObject in a sequential way, (for instance text-flow).
    static let flows_from = ATK_RELATION_FLOWS_FROM /* 8 */
    /// Indicates a subwindow attached to a component but otherwise has no connection in  the UI heirarchy to that component.
    static let subwindow_of = ATK_RELATION_SUBWINDOW_OF /* 9 */
    ...
    static let embedded_by = ATK_RELATION_EMBEDDED_BY /* 11 */
    /// Indicates that an object is a popup for another object.
    static let popup_for = ATK_RELATION_POPUP_FOR /* 12 */
    /// Indicates that an object is a parent window of another object.
    static let parent_window_of = ATK_RELATION_PARENT_WINDOW_OF /* 13 */
    ...
    static let last_defined = ATK_RELATION_LAST_DEFINED /* 21 */
}
...
public extension Role {
    ...
    static let accelerator_label = ATK_ROLE_ACCEL_LABEL /* 1 */
    ...
    static let check_box = ATK_ROLE_CHECK_BOX /* 7 */
    /// A menu item with a check box
    static let check_menu_item = ATK_ROLE_CHECK_MENU_ITEM /* 8 */
    /// A specialized dialog that lets the user choose a color
    static let color_chooser = ATK_ROLE_COLOR_CHOOSER /* 9 */
    /// The header for a column of data
    static let column_header = ATK_ROLE_COLUMN_HEADER /* 10 */
    /// A collapsible list of choices the user can select from
    static let combo_box = ATK_ROLE_COMBO_BOX /* 11 */
    /// An object whose purpose is to allow a user to edit a date
    static let date_editor = ATK_ROLE_DATE_EDITOR /* 12 */
    /// An inconifed internal frame within a DESKTOP_PANE
    static let desktop_icon = ATK_ROLE_DESKTOP_ICON /* 13 */
    /// A pane that supports internal frames and iconified versions of those internal frames
    static let desktop_frame = ATK_ROLE_DESKTOP_FRAME /* 14 */
    /// An object whose purpose is to allow a user to set a value
    static let dial = ATK_ROLE_DIAL /* 15 */
    /// A top level window with title bar and a border
    static let dialog = ATK_ROLE_DIALOG /* 16 */
    /// A pane that allows the user to navigate through and select the contents of a directory
    static let directory_pane = ATK_ROLE_DIRECTORY_PANE /* 17 */
    /// An object used for drawing custom user interface elements
    static let drawing_area = ATK_ROLE_DRAWING_AREA /* 18 */
    /// A specialized dialog that lets the user choose a file
    static let file_chooser = ATK_ROLE_FILE_CHOOSER /* 19 */
    /// A object that fills up space in a user interface
    static let filler = ATK_ROLE_FILLER /* 20 */
    /// A specialized dialog that lets the user choose a font
    static let font_chooser = ATK_ROLE_FONT_CHOOSER /* 21 */
    /// A top level window with a title bar, border, menubar, etc.
    static let frame = ATK_ROLE_FRAME /* 22 */
    /// A pane that is guaranteed to be painted on top of all panes beneath it
    static let glass_pane = ATK_ROLE_GLASS_PANE /* 23 */
    /// A document container for HTML, whose children represent the document content
    static let html_container = ATK_ROLE_HTML_CONTAINER /* 24 */
    /// A small fixed size picture, typically used to decorate components
    static let icon = ATK_ROLE_ICON /* 25 */
    /// An object whose primary purpose is to display an image
    static let image = ATK_ROLE_IMAGE /* 26 */
    /// A frame-like object that is clipped by a desktop pane
    static let internal_frame = ATK_ROLE_INTERNAL_FRAME /* 27 */
    /// An object used to present an icon or short string in an interface
    static let label = ATK_ROLE_LABEL /* 28 */
    /// A specialized pane that allows its children to be drawn in layers, providing a form of stacking order
    static let layered_pane = ATK_ROLE_LAYERED_PANE /* 29 */
    /// An object that presents a list of objects to the user and allows the user to select one or more of them
    static let list = ATK_ROLE_LIST /* 30 */
    /// An object that represents an element of a list
    static let list_item = ATK_ROLE_LIST_ITEM /* 31 */
    /// An object usually found inside a menu bar that contains a list of actions the user can choose from
    static let menu = ATK_ROLE_MENU /* 32 */
    /// An object usually drawn at the top of the primary dialog box of an application that contains a list of menus the user can choose from
    static let menu_bar = ATK_ROLE_MENU_BAR /* 33 */
    /// An object usually contained in a menu that presents an action the user can choose
    static let menu_item = ATK_ROLE_MENU_ITEM /* 34 */
    /// A specialized pane whose primary use is inside a DIALOG
    static let option_pane = ATK_ROLE_OPTION_PANE /* 35 */
    /// An object that is a child of a page tab list
    static let page_tab = ATK_ROLE_PAGE_TAB /* 36 */
    /// An object that presents a series of panels (or page tabs), one at a time, through some mechanism provided by the object
    static let page_tab_list = ATK_ROLE_PAGE_TAB_LIST /* 37 */
    /// A generic container that is often used to group objects
    static let panel = ATK_ROLE_PANEL /* 38 */
    /// A text object uses for passwords, or other places where the text content is not shown visibly to the user
    static let password_text = ATK_ROLE_PASSWORD_TEXT /* 39 */
    /// A temporary window that is usually used to offer the user a list of choices, and then hides when the user selects one of those choices
    static let popup_menu = ATK_ROLE_POPUP_MENU /* 40 */
    /// An object used to indicate how much of a task has been completed
    static let progress_bar = ATK_ROLE_PROGRESS_BAR /* 41 */
    /// An object the user can manipulate to tell the application to do something
    static let push_button = ATK_ROLE_PUSH_BUTTON /* 42 */
    /// A specialized check box that will cause other radio buttons in the same group to become unchecked when this one is checked
    static let radio_button = ATK_ROLE_RADIO_BUTTON /* 43 */
    /// A check menu item which belongs to a group. At each instant exactly one of the radio menu items from a group is selected
    static let radio_menu_item = ATK_ROLE_RADIO_MENU_ITEM /* 44 */
    /// A specialized pane that has a glass pane and a layered pane as its children
    static let root_pane = ATK_ROLE_ROOT_PANE /* 45 */
    /// The header for a row of data
    static let row_header = ATK_ROLE_ROW_HEADER /* 46 */
    /// An object usually used to allow a user to incrementally view a large amount of data.
    static let scroll_bar = ATK_ROLE_SCROLL_BAR /* 47 */
    /// An object that allows a user to incrementally view a large amount of information
    static let scroll_pane = ATK_ROLE_SCROLL_PANE /* 48 */
    ...
    static let split_pane = ATK_ROLE_SPLIT_PANE /* 51 */
    /// An object used to get an integer or floating point number from the user
    static let spin_button = ATK_ROLE_SPIN_BUTTON /* 52 */
    /// An object which reports messages of minor importance to the user
    static let statusbar = ATK_ROLE_STATUSBAR /* 53 */
    /// An object used to represent information in terms of rows and columns
    static let table = ATK_ROLE_TABLE /* 54 */
    /// A cell in a table
    static let table_cell = ATK_ROLE_TABLE_CELL /* 55 */
    /// The header for a column of a table
    static let table_column_header = ATK_ROLE_TABLE_COLUMN_HEADER /* 56 */
    /// The header for a row of a table
    static let table_row_header = ATK_ROLE_TABLE_ROW_HEADER /* 57 */
    /// A menu item used to tear off and reattach its menu
    static let tear_off_menu_item = ATK_ROLE_TEAR_OFF_MENU_ITEM /* 58 */
    ...
    static let toggle_button = ATK_ROLE_TOGGLE_BUTTON /* 61 */
    /// A bar or palette usually composed of push buttons or toggle buttons
    static let tool_bar = ATK_ROLE_TOOL_BAR /* 62 */
    /// An object that provides information about another object
    static let tool_tip = ATK_ROLE_TOOL_TIP /* 63 */
    ...
    static let tree_table = ATK_ROLE_TREE_TABLE /* 65 */
    ...
    static let edit_bar = ATK_ROLE_EDITBAR /* 75 */
    ...
    static let document_frame = ATK_ROLE_DOCUMENT_FRAME /* 80 */
    ...
    static let redundant_object = ATK_ROLE_REDUNDANT_OBJECT /* 84 */
    ...
    static let list_box = ATK_ROLE_LIST_BOX /* 96 */
    ...
    static let image_map = ATK_ROLE_IMAGE_MAP /* 98 */
    ...
    static let info_bar = ATK_ROLE_INFO_BAR /* 100 */
    ...
    static let level_bar = ATK_ROLE_LEVEL_BAR /* 101 */
    /// A bar that serves as the title of a window or a
    /// dialog. (Since: 2.12)
    static let title_bar = ATK_ROLE_TITLE_BAR /* 102 */
    /// An object which contains a text section
    /// that is quoted from another source. (Since: 2.12)
    static let block_quote = ATK_ROLE_BLOCK_QUOTE /* 103 */
    ...
    static let description_list = ATK_ROLE_DESCRIPTION_LIST /* 114 */
    /// An object that represents a term or phrase
    /// with a corresponding definition. (Since: 2.12)
    static let description_term = ATK_ROLE_DESCRIPTION_TERM /* 115 */
    /// An object that represents the
    /// description, definition or value of a term. (Since: 2.12)
    static let description_value = ATK_ROLE_DESCRIPTION_VALUE /* 116 */
    ...
    static let static_ = ATK_ROLE_STATIC /* 117 */
    /// An object that represents a mathematical fraction.
    /// (Since: 2.16)
    static let math_fraction = ATK_ROLE_MATH_FRACTION /* 118 */
    /// An object that represents a mathematical expression
    /// displayed with a radical. (Since: 2.16)
    static let math_root = ATK_ROLE_MATH_ROOT /* 119 */
    /// An object that contains text that is displayed as a
    /// subscript. (Since: 2.16)
    static let subscript_ = ATK_ROLE_SUBSCRIPT /* 120 */
    /// An object that contains text that is displayed as a
    ...
    static let content_deletion = ATK_ROLE_CONTENT_DELETION /* 123 */
    /// Content previously inserted or proposed to be
    /// inserted, e.g. in revision history or a content view providing suggestions
    /// from reviewers. (Since: 2.34)
    static let content_insertion = ATK_ROLE_CONTENT_INSERTION /* 124 */
    /// not a valid role, used for finding end of the enumeration
    static let last_defined = ATK_ROLE_LAST_DEFINED /* 125 */
}
...
public extension ScrollType {
    ...
    static let top_left = ATK_SCROLL_TOP_LEFT /* 0 */
    /// Scroll the object vertically and horizontally to the
    ///   bottom right corner of the window.
    static let bottom_right = ATK_SCROLL_BOTTOM_RIGHT /* 1 */
    /// Scroll the object vertically to the top edge of the
    ///   window.
    static let top_edge = ATK_SCROLL_TOP_EDGE /* 2 */
    /// Scroll the object vertically to the bottom edge of
    ///   the window.
    static let bottom_edge = ATK_SCROLL_BOTTOM_EDGE /* 3 */
    /// Scroll the object vertically and horizontally to the
    ///   left edge of the window.
    static let left_edge = ATK_SCROLL_LEFT_EDGE /* 4 */
    /// Scroll the object vertically and horizontally to the
    ///   right edge of the window.
    static let right_edge = ATK_SCROLL_RIGHT_EDGE /* 5 */
...
public extension StateType {
    ...
    static let multi_line = ATK_STATE_MULTI_LINE /* 15 */
    ...
    static let single_line = ATK_STATE_SINGLE_LINE /* 24 */
    ...
    static let manages_descendants = ATK_STATE_MANAGES_DESCENDANTS /* 29 */
    ...
    static let required_ = ATK_STATE_REQUIRED /* 32 */
    ...
    static let invalid_entry = ATK_STATE_INVALID_ENTRY /* 33 */
    ...
    static let supports_autocompletion = ATK_STATE_SUPPORTS_AUTOCOMPLETION /* 34 */
    /// Indicates that the object in question supports text selection. It should only be exposed on objects which implement the Text interface, in order to distinguish this state from `ATK_STATE_SELECTABLE`, which infers that the object in question is a selectable child of an object which implements Selection. While similar, text selection and subelement selection are distinct operations.
    static let selectable_text = ATK_STATE_SELECTABLE_TEXT /* 35 */
    ...
    static let default_ = ATK_STATE_DEFAULT /* 36 */
...
public extension TextAttribute {
    ...
    static let left_margin = ATK_TEXT_ATTR_LEFT_MARGIN /* 1 */
    /// The pixel width of the right margin
    static let right_margin = ATK_TEXT_ATTR_RIGHT_MARGIN /* 2 */
    ...
    static let pixels_above_lines = ATK_TEXT_ATTR_PIXELS_ABOVE_LINES /* 6 */
    /// Pixels of blank space to leave below each newline-terminated line.
    static let pixels_below_lines = ATK_TEXT_ATTR_PIXELS_BELOW_LINES /* 7 */
    /// Pixels of blank space to leave between wrapped lines inside the same newline-terminated line (paragraph).
    static let pixels_inside_wrap = ATK_TEXT_ATTR_PIXELS_INSIDE_WRAP /* 8 */
    /// "true" or "false" whether to make the background color for each character the height of the highest font used on the current line, or the height of the font used for the current character.
    static let bg_full_height = ATK_TEXT_ATTR_BG_FULL_HEIGHT /* 9 */
    ...
    static let family_name = ATK_TEXT_ATTR_FAMILY_NAME /* 17 */
    /// The background color. The value is an RGB value of the format "`u`,`u`,`u`"
    static let bg_color = ATK_TEXT_ATTR_BG_COLOR /* 18 */
    /// The foreground color. The value is an RGB value of the format "`u`,`u`,`u`"
    static let fg_color = ATK_TEXT_ATTR_FG_COLOR /* 19 */
    /// "true" if a `GdkBitmap` is set for stippling the background color.
    static let bg_stipple = ATK_TEXT_ATTR_BG_STIPPLE /* 20 */
    /// "true" if a `GdkBitmap` is set for stippling the foreground color.
    static let fg_stipple = ATK_TEXT_ATTR_FG_STIPPLE /* 21 */
    /// The wrap mode of the text, if any. Values are "none", "char", "word", or "word_char".
    static let wrap_mode = ATK_TEXT_ATTR_WRAP_MODE /* 22 */
    ...
    static let last_defined = ATK_TEXT_ATTR_LAST_DEFINED /* 28 */
}
...
public extension TextBoundary {
    ...
    static let word_start = ATK_TEXT_BOUNDARY_WORD_START /* 1 */
    /// Boundary is the end (i.e. last
    /// character) of a word.
    static let word_end = ATK_TEXT_BOUNDARY_WORD_END /* 2 */
    /// Boundary is the first character in a sentence.
    static let sentence_start = ATK_TEXT_BOUNDARY_SENTENCE_START /* 3 */
    /// Boundary is the last (terminal)
    /// character in a sentence; in languages which use "sentence stop"
    /// punctuation such as English, the boundary is thus the '.', '?', or
    /// similar terminal punctuation character.
    static let sentence_end = ATK_TEXT_BOUNDARY_SENTENCE_END /* 4 */
    /// Boundary is the initial character of the content or a
    /// character immediately following a newline, linefeed, or return character.
    static let line_start = ATK_TEXT_BOUNDARY_LINE_START /* 5 */
    /// Boundary is the linefeed, or return
    /// character.
    static let line_end = ATK_TEXT_BOUNDARY_LINE_END /* 6 */
}
...
public extension TextClipType {
    ...
    static let none_ = ATK_TEXT_CLIP_NONE /* 0 */
...
public extension ValueType {
    static let very_weak = ATK_VALUE_VERY_WEAK /* 0 */
    static let weak_ = ATK_VALUE_WEAK /* 1 */
    static let acceptable = ATK_VALUE_ACCEPTABLE /* 2 */
    static let strong = ATK_VALUE_STRONG /* 3 */
    static let very_strong = ATK_VALUE_VERY_STRONG /* 4 */
    static let very_low = ATK_VALUE_VERY_LOW /* 5 */
    static let low = ATK_VALUE_LOW /* 6 */
    static let medium = ATK_VALUE_MEDIUM /* 7 */
    static let high = ATK_VALUE_HIGH /* 8 */
    static let very_high = ATK_VALUE_VERY_HIGH /* 9 */
    static let very_bad = ATK_VALUE_VERY_BAD /* 10 */
    static let bad = ATK_VALUE_BAD /* 11 */
    static let good = ATK_VALUE_GOOD /* 12 */
    static let very_good = ATK_VALUE_VERY_GOOD /* 13 */
    static let best = ATK_VALUE_BEST /* 14 */
    static let last_defined = ATK_VALUE_LAST_DEFINED /* 15 */
}
